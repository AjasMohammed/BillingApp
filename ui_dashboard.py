...
################################################################################
## Form generated from reading UI file 'dashboardgxwUjQ.ui'
##
...
"border-radius: 10px;")
        ...
        sizePolicy4.setHeightForWidth(self.customer_name_field.sizePolicy().hasHeightForWidth())
        self.customer_name_field.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.customer_contact_field.sizePolicy().hasHeightForWidth())
        self.customer_contact_field.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.product_name_field.sizePolicy().hasHeightForWidth())
        self.product_name_field.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.product_id_field.sizePolicy().hasHeightForWidth())
        self.product_id_field.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.product_price_field.sizePolicy().hasHeightForWidth())
        self.product_price_field.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.product_qty_field.sizePolicy().hasHeightForWidth())
        self.product_qty_field.setSizePolicy(sizePolicy4)
        ...
        sizePolicy5.setHeightForWidth(self.add_btn.sizePolicy().hasHeightForWidth())
        self.add_btn.setSizePolicy(sizePolicy5)
...
"border-radius:12px;")
        ...
        sizePolicy6.setHeightForWidth(self.bill_view.sizePolicy().hasHeightForWidth())
        self.bill_view.setSizePolicy(sizePolicy6)
        self.bill_view.setMaximumSize(QSize(16777215, 575))
        ...
        sizePolicy5.setHeightForWidth(self.bill_table.sizePolicy().hasHeightForWidth())
        self.bill_table.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.bill_tag_field.sizePolicy().hasHeightForWidth())
        self.bill_tag_field.setSizePolicy(sizePolicy5)
...
"")
        ...
        sizePolicy9.setHeightForWidth(self.vis_btn.sizePolicy().hasHeightForWidth())
        self.vis_btn.setSizePolicy(sizePolicy9)
